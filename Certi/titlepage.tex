...
\newcommand{\projecttitle}{\Huge \bf{Certificate Generation System}\vskip 0.2in}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.3\textwidth]{images/gne.jpg}                   
%\caption{GNE}
\hspace{-1.5em}
\end{figure}
...
{Submitted By:}\\
\textnormal{Deepti Sharma\\
D3CSE-A1\\1410821\\(145021)} \\\\


\textnormal{Amisha Budhiraja\\
D3CSE-A1\\1410808\\(145010)}
% Your name
\end{flushleft}
\end{minipage}
~
